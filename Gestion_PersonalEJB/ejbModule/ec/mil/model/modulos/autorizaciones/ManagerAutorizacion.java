...
public class ManagerAutorizacion {
	...
	public List<AutRolPerfil> findRolPerfilbyRol(AutRole objAutRol, VAutMenuRol vAutMenuRol) throws Exception {
		try {
			return managerDAOGestionPersonal.findWhere(AutRolPerfil.class, "o.autRole.id="+objAutRol.getId()+" and o.estado='A' and o.autPerfile.estado='A' and o.autPerfile.autMenu.id="+vAutMenuRol.getId(), "o.autPerfile.orden ASC");
		} catch (Exception e) {
